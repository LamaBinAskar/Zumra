...
<body>
  ...
  <div class="cert">
    ...
    <p class="achievement">
      ...
      <br>
      <span style="font-size:12px;color:rgba(255,255,255,.60)">
...
يسرنا أن نتقدم بأسمى آيات التهنئة والتقدير تقديراً لما أبداه من تفانٍ في تقديم المساعدة لزملائه وإرشادهم أكاديمياً، وتطوّعه بسخاء وقته وجهده في خدمة مجتمعه الجامعي.
مع تمنياتنا له بالتوفيق والنجاح في مسيرته العلمية والمهنية.
